...
use embassy_stm32::timer::low_level::{OutputCompareMode, OutputPolarity, RoundTo, Timer};
...
use uf_dshot::command::{BidirTx, Command, DshotSpeed, EncodedFrame, UniTx, WaveformTiming};
    ...
    D: UpDma<T>,
{
    ...
    tx_dma: DmaChannel<'d>,
    tx_dma_request: embassy_stm32::dma::Request,
